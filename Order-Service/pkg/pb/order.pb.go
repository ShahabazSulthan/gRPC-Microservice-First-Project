...
var file_pkg_pb_order_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0x56, 0x0a,
	...
	0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x55, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x20, 0x0a, 0x0e, 0x46,
	...
	0x72, 0x32, 0xf4, 0x01, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x53, 0x65, 0x72,
...
func file_pkg_pb_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_pb_order_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_pb_order_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pkg_pb_order_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pkg_pb_order_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_pkg_pb_order_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_pkg_pb_order_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_pkg_pb_order_proto_msgTypes[6].Exporter = func(v any, i int) any {
